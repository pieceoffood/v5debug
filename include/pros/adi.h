 ...
 * @Last modified time: 2018-10-25T08:36:13+08:00
 */
 ...
 */
	...
	*在给定端口上初始化陀螺仪。如果给定的端口没有
	 *之前已配置为陀螺仪，此功能启动1300 ms
	 *校准期。
	 *
	 *强烈建议从initialize（）调用此函数
	 *机器人静止不动以确保正确校准。
	 *
	 *当错误状态为时，此函数使用以下errno值
	 * 到达：
	 ...
	 *由ADI提供
	 *
	 * \ return包含给定端口的adi_gyro_t对象，如果是，则返回PROS_ERR
	 *初始化失败。。
 */
